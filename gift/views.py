...
def item_edit(request, item_id):
    ...
    if not (is_owner or is_manager):
        messages.error(request, 'You can only edit items in your own wishlists or wishlists you manage.')
    ...
    return render(request, 'gift/item_edit.html', {'form': form, 'item': item, 'wishlist': item.wishlist})
        ...
        if form.is_valid():
            try:
                ...
                if new_family_name:
                    ...
                    family_description = new_family_poem if new_family_poem else f'Family group for {new_family_name}'
                    family, created = Family.objects.get_or_create(
                        name=new_family_name,
                        defaults={'description': family_description}
                    )
                ...
                if scraped_page:
                    ...
                    if wishlist:
                        ...
                        messages.warning(request, 'Wishlist created, but there was an error importing items.')
...
def wishlist_detail(request, wishlist_id):
    ...
    return render(request, 'gift/wishlist_detail.html',
                  {'wishlist': wishlist, 'sorted_category_items': sorted_category_items, 
                   'uncategorized_items': uncategorized_items,
                   'is_owner': is_owner, 'is_steward': is_steward, 'is_manager': is_manager,
...
def wishlist_edit(request, wishlist_id):
    ...
    return render(request, 'gift/wishlist_edit.html', {
        'formset': formset, 
        'wishlist': wishlist,
...
def category_edit(request, category_id):
    ...
    return render(request, 'gift/category_edit.html', {
        'form': form, 
        'category': category,
        'wishlist': wishlist
    })
