...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f'Destination PostgreSQL: {current_db["HOST"]}:{current_db.get("PORT", 5432)}/{current_db["NAME"]}')
        ...
        try:
            ...
            try:
                ...
                with transaction.atomic(using='default'):
                    ...
                    self.stdout.write(self.style.SUCCESS('Successfully migrated all data to PostgreSQL!'))
            except Exception as e:
                if skip_existing and ('duplicate key' in str(e).lower() or 'unique constraint' in str(e).lower()):
