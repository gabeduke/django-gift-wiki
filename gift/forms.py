...
from .models import Suggestion, WishList, Item, Category, ScrapedWikiPage
...
class ItemForm(forms.ModelForm):
    ...
    class Meta:
        model = Item
        fields = ['name', 'description', 'price', 'price_range']
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['name'].widget.attrs['placeholder'] = 'Enter item name (e.g., "Nintendo Switch", "Coffee Maker")'
...
def get_item_modelformset(wishlist):
    ...
    ItemModelFormSet = modelformset_factory(
        Item,
        form=ItemEditForm,
        fields=['name', 'description', 'price', 'price_range', 'purchased'],
...
class WishListForm(forms.ModelForm):
    ...
    class Meta:
        model = WishList
        fields = ['title', 'description', 'family_name']  # Removed 'image' - not needed for wishlists
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['description'].help_text = 'Share a note, story, or memory about this wishlist (optional)'
        self.fields['description'].widget.attrs['placeholder'] = 'Write a note, story, or memory about this wishlist...'
        ...
        for name, field in self.fields.items():
            if not field.required and name not in ['new_family_name', 'new_family_poem', 'scraped_page']:
