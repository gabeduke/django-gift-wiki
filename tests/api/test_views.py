...
class TestWishlistManagers:
    ...
    def test_manager_can_edit_wishlist(self, authenticated_user, authenticated_other_user, wishlist, other_user):
    ...
    def test_manager_can_edit_items(self, authenticated_user, authenticated_other_user, wishlist, item, other_user):
